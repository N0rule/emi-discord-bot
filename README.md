...
<p align="center"style="font-size:130%;"><a href="https://github.com/saiteja-madha/discord-js-bot"><b>Strange bot</a> fork with added functionality and translation</b></p>
<br>
<p align="center"><b>Admin, AutoMod, Anime, Economy, Fun, Giveaway, Image, Invite, Information, Moderation, Music, Owner, Social, Statistics, Suggestion, Ticket, Utility and More...</b></p>
<br>
<p align="center" style="font-size:160%;"><b>Still in Beta</b></p>
<br>
...
<p align="center">
  ...
  •
  <a href="https://discord.gg/cfa3aFFtAX">Test Server</a>
</p>
...
```
git clone https://github.com/N0rule/emi-discord-bot.git
cd discord-js-bot
npm install
```
...
-  respectively, and fill in the required values.
- Rename `config.js.example` to `config.js` and optionaly edit `config.js`
...
- **Multi-Function clear Commands.** <br /> _Commands:_ `clear`, `clear attach`, `clear bots`, `clear links`, `clear token`, `clear user`, ...
...
- **CHATGPT intagrated chatbot!** Enjoy high quality chatting with AI
- **AI Photo-generation** Generate photos using promts
### 🎉 **Giveaways:**
