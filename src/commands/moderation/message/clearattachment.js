...
module.exports = {
  name: "clearattach",
  description: "удаляет указанное количество сообщений с вложениями",
  category: "MODERATION",
  ...
  command: {
    enabled: true,
    usage: "[amount]",
    aliases: ["clearattachment", "clearattachments"],
  },
  ...
  async messageRun(message, args) {
    ...
    const response = await clearMessages(message.member, message.channel, "ATTACHMENT", amount);
